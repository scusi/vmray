...
from a file called 'GlobalSignRootCA.pem'. This certificate is added to
...
is to replace the content of 'GlobalSignRootCA.pem' with the cert of your 
root CA.
...
TLS config switch 'InsecureSkipVerify'.
